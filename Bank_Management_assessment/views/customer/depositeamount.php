            ...
            <tr>
                <th>
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="damount" id="damount" required><br>
                    </div>
                </th>
            </tr>
            <th>
                ...
                <div class="col-12">
                    <input type="submit" class="btn btn-secondary" name="deposite" value="deposite">
                </div>
