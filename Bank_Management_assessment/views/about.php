        ...
        <div class="about-inner about editContent">
            ...
            <div class="breadcrumbs-sub">
                <ul class="breadcrumbs-custom-path">
                    <li class="right-side propClone"><a href="home" class="editContent">Home <span class="fa fa-angle-right" aria-hidden="true"></span></a> <p></li>
        ...
        <div class="container">
            ...
            <div class="cwp4-two row">
                <div class="cwp4-text col-lg-6 col-md-6">
                    ...
                    <p class="para editContent">Mollitia placeat modi explicabo voluptatum Vel unde sint error placeat. Alias modi molestias blanditiis aspernatur? Ex iusto nam ipsum aliquam.
</p>
        </div>
        </div>
                <div class="cwp4-text col-lg-6 col-md-6 ">
...
<section class="w3l-about ">
      <div class="skills-bars editContent counter-width ">
            <div class="container">
              ...
              <p class="para both-para mt-3">Qui ducimus vero aliquam odit deserunt voluptatum itaque, enim perspiciatis animi ipsam quasi deleniti nam asperiores ullam, obcaecati veniam, eaque eius consequatur.</p>
            </div>
	...
	<div class="team-content-page editContent ">
		...
		<div class="container">
			...
			<div class="at-grid" data-column="3">
			  <div class="at-column">
				<div class="at-user">
				  <div class="at-user__avatar"><img src=" <?php echo $this->baseURL ; ?>assets/images/c1.jpg" alt="product" class="img-responsive about-me"> </div><div class="at-user__name">Aaron Rossi</div>
			  ...
			  <div class="at-column">
				<div class="at-user">
				  <div class="at-user__avatar"><img src=" <?php echo $this->baseURL ; ?>assets/images/c2.jpg"/></div>
			  ...
			  <div class="at-column">
				<div class="at-user">
				  <div class="at-user__avatar"><img src=" <?php echo $this->baseURL ; ?>assets/images/c3.jpg"/></div>
